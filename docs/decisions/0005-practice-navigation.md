...
Scope: Owner-reported Inspect dead end, plus the follow-up report that “+ Add stage” appeared to do nothing. Fixes the approved practice workflow; no new workflow authority.
...
- Baseline: 89 unit tests and 21 browser tests. Final suite adds one observation-progress unit test and nine browser regressions.
